...
def bag_of_words(images, k, n_images):
    ...
    joblib.dump(clf_k, "/Users/fredlu/Developer/ComputerVision/FlowerDetector/FlowerDetector/trainedModel/kmeans_"+str(k)+".m")
...
def bag_of_words_test(images, k):
    clf_k = joblib.load("/Users/fredlu/Developer/ComputerVision/FlowerDetector/FlowerDetector/trainedModel/kmeans_"+str(k)+".m")
    n_images = len(images)
